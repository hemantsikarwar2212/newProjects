...
export const Carousel = () => {
  ...
  const SamplePrevArrow = (props) => {
    ...
    return (
      <div
        onClick={onClick}
        className={`arrow ${className} style={{zIndex:3}}`}
      >
        <AiOutlineArrowLeft
          className="arrows"
          style={{
              ...
              <div className="flex gap-10 justify-center h-[600px] items-center px-4">
                <div className="space-y-6">
                  <h3 className="text-black-500 font-semibold font-sans text-sm">
                    ...
                    Cum necessitatibus eaque nobis reiciendis dignissimos
                    asperiores, deleniti blanditiis cumque quisquam ut.
                  </h3>
                  <h1 className="text-4xl font-bold uppercase line-clamp-3 md:w-[500px] text-white">
                    {item.title}
                  </h1>
                  <p className="md:w-[400px] line-clamp-3 text-gray-400 pr-7 ">
                    {item.description}
                  </p>
